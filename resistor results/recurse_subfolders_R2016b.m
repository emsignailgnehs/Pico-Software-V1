function recurse_subfolders_R2016b(resultName)
...
start_path = 'C:/Users/aptitude3/Desktop/Tyler Desktop/Pico Software V1/resistor results';
...
% 		fprintf('     Processing file %d of %d : "%s".\n', k, totalNumberOfFiles, fullFileName);
		...
		fprintf('%s\n', baseNameNoExt);
        matrix = csvread(fullFileName);
        average = mean(matrix, 'all');
        run = [run; average];
    end
    csvwrite(strcat(thisFolder,'/',resultName),run);
else
